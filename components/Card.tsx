...
const Card = ({iconPath,title,children}:Props) => {
  return (
    <div className="transition-all duration-700 delay-50 cursor-pointer ease-out bg-transparent h-fit  p-5 mx-2 text-black shadow-2xl z-40 rounded-xl hover:bg-[#238636] hover:bg-opacity-70 group max-w-xl hover:flex " >
      ...
      <div className="">
          ...
          <div className=" space-y-2">
            <p className="font-semibold mt-6 -[-20%] text-2xl lg:txt-4xl text-center group-hover-base lg:group-hover:text-2xl group-hover:text-left transition ease-in delay-50">{title}</p>
