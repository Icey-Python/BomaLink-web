...
const aboutus = () => {
  return (
    ...
    <p className="text-2xl py-3 font-poppins font-medium">Welcome to <strong className="font-bold text-green-900">Bomalink!</strong><br/>
    <p className="mt-4">Where we aim at bringing out peaceful coexistence <br/> between pastoralists and agriculturalists, enabling <br/> them to make better decisions for the future. <br/></p> <strong className='font-bold text-green-900'>”Maamuzi sahihi, ushirikiano wa kudumu”</strong>
